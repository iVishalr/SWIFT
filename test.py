...
testset_personal = prepare_testset.MakeTestSet(f"{dataset_path}Personal/", None, args.scale, args.patch_size, testing=True)
...
custom_data_loader = DataLoader(dataset=testset_personal, num_workers=0, batch_size=args.test_batch_size, shuffle=False)
test_data_loader_dict = {"Set5": Set5_data_loader, "Set14": Set14_data_loader, "BSD100": BSDS100_data_loader, "Urban100": Urban100_data_loader, "Manga109": Manga109_data_loader, "General100": General100_data_loader, "Personal": custom_data_loader}
...
def test(model_path, model_type="small"):
    ...
    model_paths = [
        (args.model_path if args.model_path else "/home/vishalr/Desktop/EffcNet-Efficient-Fast-Fourier-Convolution-Network/experiment/EFFCNet-S-4x-662k.pth", 1), #(path, weight)
    ]
        ...
        for i, batch in enumerate(test_data_loader):
            ...
            for pre,w in pred:
                ...
                if testset == 'Personal':
                    ...
                    output_img.save(f"./results/effcnetx{args.scale}/{i+1}.png")
                    continue
